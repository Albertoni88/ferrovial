...
import { Button, Dimensions, Image, TextInput, View, Text, TouchableOpacity, Alert, Platform, StyleSheet, ScrollView } from 'react-native';
...
export default function InformacionTecnica({ navigation, props }) {
