...
export default function MainHeader({ navigation, props }) {
  ...
  const incidenciasOriginals = useReduxSelector(
    (state) => state.incidencia.incidenciasOriginals
  );
        ...
        <View style={styles.containerSide}>
          ...
          <ScrollView>
            ...
            >
              ...
              <Text style={styles.navItemStyle}>Editar perfil</Text>
            </TouchableOpacity>
            ...
            <View>
              ...
              >
                ...
                <Text style={styles.navItemStyle}>Preguntas frecuentes</Text>
              </TouchableOpacity>
            </View>
            <View>
              <TouchableOpacity
              ...
              >
                ...
                <Text style={styles.navItemStyle}>Avisos legales</Text>
              </TouchableOpacity>
              <TouchableOpacity
                onPress={() => {
              ...
              >
                ...
                <Text style={styles.navItemStyle}>Políticas de privacidad</Text>
              </TouchableOpacity>
              <TouchableOpacity
                onPress={() => {
              ...
              >
                ...
                <Text style={styles.navItemStyle}>Información técnica</Text>
              </TouchableOpacity>
            </View>
            <View>
              <TouchableOpacity
              ...
              >
                ...
                <Text style={styles.navItemStyle}>Info de producto</Text>
              </TouchableOpacity>
            </View>
          </ScrollView>
  ...
  const FiltrarIncidencia = (searchStringInput) => {
    if (searchStringInput === "") {
      ...
      incidenciasOriginals.forEach((element) => {
        if (
          element.autor_fullname
            .toLowerCase()
            .includes(searchStringInput.toLowerCase()) ||
          element.autor_username
            .toLowerCase()
            .includes(searchStringInput.toLowerCase()) ||
          element.direccion
            .toLowerCase()
            .includes(searchStringInput.toLowerCase()) ||
          element.tipo_incidencia
            .toLowerCase()
            .includes(searchStringInput.toLowerCase()) ||
          element.estado
            .toLowerCase()
  ...
  return (
    <View style={{ flex: 1, height: windowHeight }}>
      ...
      {map === true && (
        ...
        >
          <Map
            filtroMapa={FiltrarIncidencia}
            cantidadIncidencias={incidenciasOriginals.length}
        ...
        >
          <LinearGradient
            colors={[
              "transparent",
              "transparent",
              end === true ? "transparent" : COLORS.PALE_GREY,
            ]}
            start={{ x: 0, y: 0.2 }}
            end={{ x: 0, y: 1 }}
